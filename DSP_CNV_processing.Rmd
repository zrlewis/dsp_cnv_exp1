...
# #  scale_y_continuous(limits = c(0,6))+
#   labs(title="variant") +
#   geom_hline(yintercept=log2(neg_mean_S1)) +
#   geom_hline(yintercept = log2(neg_mean_S1 + 2*neg_sd_S1), color = "blue",lty = 2)# +
# #  geom_hline(yintercept = log2(neg_mean_S1 - 2*neg_sd_S1), color = "blue",lty = 2) 
# 
...
erbb2_snr <- bind_cols(erbb_S1,erbb_S2,erbb_S5)
erbb2_snr_melt <- erbb2_snr %>% reshape2::melt()

ggplot(erbb2_snr_melt, aes(x = value,fill=variable)) + 
